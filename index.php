...
<div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
  <div class="owl-carousel header-carousel position-relative">
    ...
    $selb = "SELECT * FROM banners   ORDER BY  ban_id DESC LIMIT 0,6";
          ...
          <div class="container">
            <div class="row justify-content-start">
              <div class="col-10 col-lg-8">
                ...
                <a href="<?= $banner['ban_url']; ?>" class="btn btn-primary rounded-pill py-3 px-5 animated slideInLeft">
                  <?= $banner['ban_button']; ?>
                </a>
              </div>
            </div>
      ...
      <div class="col-lg-6 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
        <div class="p-lg-5 pe-lg-0">
          ...
          <p>Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum
            et lorem et sit, sed stet lorem sit clita duo justo erat amet</p>
          <p>
            <i class="fa fa-check-circle text-primary me-3"></i>Diam dolor diam ipsum
          </p>
          <p>
            <i class="fa fa-check-circle text-primary me-3"></i>Aliqu diam amet diam et eos
          </p>
          <p>
