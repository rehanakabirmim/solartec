      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="row mb-3">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control form_control" id="" name="Stitle" value="<?= $data['service_title']; ?>">
            </div>
          </div>
          <div class="row mb-3">
            <label class="col-sm-3 col-form-label col_form_label">Sdetails:</label>
            <div class="col-sm-7">
              <input type="text" class="form-control form_control" id="" name="Sdetails" value="<?= $data['service_details']; ?>">
            </div>
          </div>
          <div class="row mb-3">
